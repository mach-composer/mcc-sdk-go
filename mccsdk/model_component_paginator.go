...
// checks if the ComponentPaginator type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ComponentPaginator{}
...
func (o *ComponentPaginator) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varComponentPaginator)
