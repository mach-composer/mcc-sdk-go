...
// checks if the SiteComponentPaginator type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SiteComponentPaginator{}
...
type _SiteComponentPaginator SiteComponentPaginator
...
func (o *SiteComponentPaginator) UnmarshalJSON(data []byte) (err error) {
	...
	varSiteComponentPaginator := _SiteComponentPaginator{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSiteComponentPaginator)

	if err != nil {
		return err
	}

	*o = SiteComponentPaginator(varSiteComponentPaginator)

	return err
}

type NullableSiteComponentPaginator struct {
	value *SiteComponentPaginator
	isSet bool
}

func (v NullableSiteComponentPaginator) Get() *SiteComponentPaginator {
	return v.value
}

func (v *NullableSiteComponentPaginator) Set(val *SiteComponentPaginator) {
	v.value = val
	v.isSet = true
}

func (v NullableSiteComponentPaginator) IsSet() bool {
	return v.isSet
}
...
func NewNullableSiteComponentPaginator(val *SiteComponentPaginator) *NullableSiteComponentPaginator {
	return &NullableSiteComponentPaginator{value: val, isSet: true}
}
