...
type _JSONPatchRequestRemove JSONPatchRequestRemove
...
func (o *JSONPatchRequestRemove) UnmarshalJSON(data []byte) (err error) {
	...
	varJSONPatchRequestRemove := _JSONPatchRequestRemove{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varJSONPatchRequestRemove)

	if err != nil {
		return err
	}

	*o = JSONPatchRequestRemove(varJSONPatchRequestRemove)
