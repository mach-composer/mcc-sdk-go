...
// checks if the CommitDataWithVersionPaginator type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommitDataWithVersionPaginator{}
...
type _CommitDataWithVersionPaginator CommitDataWithVersionPaginator
...
func NewCommitDataWithVersionPaginator(count int32, total int64, offset int32, limit int32, results []CommitDataWithVersion) *CommitDataWithVersionPaginator {
	this := CommitDataWithVersionPaginator{}
	this.Count = count
	this.Total = total
	this.Offset = offset
	this.Limit = limit
...
func (o *CommitDataWithVersionPaginator) UnmarshalJSON(data []byte) (err error) {
	...
	varCommitDataWithVersionPaginator := _CommitDataWithVersionPaginator{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCommitDataWithVersionPaginator)

	if err != nil {
		return err
	}

	*o = CommitDataWithVersionPaginator(varCommitDataWithVersionPaginator)

	return err
}

type NullableCommitDataWithVersionPaginator struct {
	value *CommitDataWithVersionPaginator
	isSet bool
}

func (v NullableCommitDataWithVersionPaginator) Get() *CommitDataWithVersionPaginator {
	return v.value
}

func (v *NullableCommitDataWithVersionPaginator) Set(val *CommitDataWithVersionPaginator) {
	v.value = val
	v.isSet = true
}

func (v NullableCommitDataWithVersionPaginator) IsSet() bool {
	return v.isSet
}

func (v *NullableCommitDataWithVersionPaginator) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCommitDataWithVersionPaginator(val *CommitDataWithVersionPaginator) *NullableCommitDataWithVersionPaginator {
	return &NullableCommitDataWithVersionPaginator{value: val, isSet: true}
}
